...
palabraSecretaAjustes = "1" #establecemos la contraseña para ajustar las cofiguraciones
nombreArchivoGrupos = "grupos.txt" #establecemos el archivo de las palabras
...
def imprimirAhorcado(): #el dibujo del ahorcado cuando pierdes
    if intentos == 1:
        print("""
                       ___
                      |   |
        ...
        print("""
                    ...
                    ______|
        """)
    elif intentos == 6: #el dibujo del ahorcado al inicio
        print("""
                       ___
                      |   |
                      O   |
...
def jugar(): #se define todo el proceso de la opcion jugar
    ...
    print("Tiempo transcurrido:", round(elapsed_time, 2), "segundos.")
